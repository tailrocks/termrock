...
| 0420 | `v0.14.0` | [Overlay pointer routing honors input ownership](migrations/0420-v0.14.0-overlay-tooltip-pointer-pass-through.md) |
...
| 0431 | `v0.14.0` | [Picker one-shot actions](migrations/0431-v0.14.0-picker-one-shot-actions.md) |
| 0432 | `v0.14.0` | [HistoryPicker one-shot actions](migrations/0432-v0.14.0-history-picker-mutation-actions.md) |
| 0433 | `v0.14.0` | [Select lifecycle actions](migrations/0433-v0.14.0-select-lifecycle-actions.md) |
| 0434 | `v0.14.0` | [HintBar alignment is honored](migrations/0434-v0.14.0-hint-bar-alignment.md) |
...
| 0444 | `v0.14.0` | [MenuBar focused closed-bar gutter](migrations/0444-v0.14.0-menu-bar-focus-gutter.md) |
...
| 0469 | `v0.14.0` | [QuickOpen physical one-shot actions](migrations/0469-v0.14.0-quick-open-one-shot-actions.md) |
| 0470 | `v0.14.0` | [CommandPalette physical one-shot actions](migrations/0470-v0.14.0-command-palette-one-shot-actions.md) |
| 0471 | `v0.14.0` | [PromptComposer physical one-shot actions](migrations/0471-v0.14.0-prompt-composer-one-shot-actions.md) |
| 0472 | `v0.14.0` | [TextArea physical one-shot actions](migrations/0472-v0.14.0-text-area-one-shot-actions.md) |
| 0473 | `v0.14.0` | [Remove the zero-reference `Toggle::solid` builder](migrations/0473-v0.14.0-remove-toggle-solid-builder.md) |
| 0474 | `v0.14.0` | [Remove the orphan backdrop adapter](migrations/0474-v0.14.0-remove-orphan-backdrop-adapter.md) |
...
| 0484 | `v0.14.0` | [Synchronize removed interaction and outcome variants](migrations/0484-v0.14.0-sync-removed-interaction-outcome-variants.md) |
| 0485 | `v0.14.0` | [Synchronize tranche-one orphan function removals](migrations/0485-v0.14.0-sync-tranche-one-orphan-functions.md) |
| 0486 | `v0.14.0` | [Synchronize tranche-two orphan getter and method removals](migrations/0486-v0.14.0-sync-tranche-two-orphan-methods.md) |
| 0487 | `v0.14.0` | [Synchronize orphan public function removals](migrations/0487-v0.14.0-sync-orphan-public-functions.md) |
...
| 0503 | `v0.14.0` | [Synchronize removed KeyReleaseReporting getter](migrations/0503-v0.14.0-sync-removed-key-release-reporting-getter.md) |
...
| 0513 | `v0.14.0` | [Synchronize removed IntegrationHealth glyph getter](migrations/0513-v0.14.0-sync-removed-integration-health-glyph-getter.md) |
| 0514 | `v0.14.0` | [Synchronize removed MetricAlertSeverity letter getter](migrations/0514-v0.14.0-sync-removed-metric-alert-severity-letter-getter.md) |
...
| 0519 | `v0.14.0` | [Synchronize removed AnsiStream plain projection](migrations/0519-v0.14.0-sync-removed-ansi-stream-plain-projection.md) |
