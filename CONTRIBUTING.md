...
map, required consumer edits, before/after examples, removed concepts, and
validation commands. Do not rewrite older migration boundaries. After `v0.6.0`, `semver-candidate`,
