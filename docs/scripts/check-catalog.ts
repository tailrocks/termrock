...
console.log(
  `catalog: ${publicWidgets.size}/135 public widgets, ${routes.length}/165 component routes, ${patterns.length}/35 patterns, ${embedded.size} live demos, ${catalog.length} stories`,
)
