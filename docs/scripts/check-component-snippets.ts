...
if (files.length !== 167) throw new Error(`canonical component page drift: ${files.length}`)
...
if (names.length !== 137) throw new Error(`public widget inventory drift: ${names.length}`)
...
console.log(`verified 167 exact catalog snippets and ${names.length} public widget imports`)
