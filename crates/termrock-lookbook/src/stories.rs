...
//! Story definitions and render functions for the termrock lookbook.
//!
...
fn story_panel_focused(frame: &mut Frame<'_>, area: Rect) {
    ...
    frame.render_widget(
        Paragraph::new(vec![
            Line::from(vec![
                Span::styled("Name: ", termrock::theme::BOLD_WHITE),
                Span::styled("jackin-core", termrock::theme::GREEN),
            ]),
            Line::from(vec![
                Span::styled("Role: ", termrock::theme::BOLD_WHITE),
                Span::styled(
                    "github.com/jackin-project/roles/rust",
                    termrock::theme::GREEN,
                ),
            ]),
            Line::from(vec![
                Span::styled("Agent: ", termrock::theme::BOLD_WHITE),
                Span::styled("codex", termrock::theme::GREEN),
            ]),
            Line::from(vec![
                Span::styled("Mounts: ", termrock::theme::BOLD_WHITE),
                Span::styled("repo rw, ~/.config/gh ro", termrock::theme::DIM),
            ]),
        ]),
        content_area,
    );
...
fn story_status_popup_default(frame: &mut Frame<'_>, area: Rect) {
    let state = termrock::components::StatusPopupState::new(
        "Loading role",
...
fn story_select_list_agent_picker(frame: &mut Frame<'_>, area: Rect) {
    ...
    let context = [
        Line::from(vec![
            Span::styled("Workspace: ", termrock::theme::BOLD_WHITE),
            Span::styled("jackin-core", termrock::theme::GREEN),
        ]),
        Line::from(vec![
            Span::styled("Role: ", termrock::theme::BOLD_WHITE),
            Span::styled("rust", termrock::theme::GREEN),
        ]),
    ];
...
// the lookbook crate depends only on termrock and cannot reference the launch
...
fn story_status_footer_cockpit_chrome(frame: &mut Frame<'_>, area: Rect) {
    use termrock::components::{bottom_chrome_areas, render_hint_bar};
