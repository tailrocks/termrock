...
impl StoryInteraction for ScrollablePanelInteractor {
    ...
    fn handle_key(&mut self, key: KeyEvent) -> bool {
        ...
        let viewport_height = termrock::components::viewport_height(self.last_area);
    ...
    fn handle_mouse(&mut self, mouse: MouseEvent, preview_area: Rect) -> bool {
        ...
        let content_width = termrock::components::max_line_width(&lines);
        let content_height = lines.len();
        let viewport_width = termrock::components::viewport_width(preview_area);
        let viewport_height = termrock::components::viewport_height(preview_area);
