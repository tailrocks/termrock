...
The public widget set is derived from the reviewed API report and currently contains `Accordion`, `ActivityShelf`, `AgentModeSelector`, `ActionBar`, `ActionLink`, `AttachmentChip`, `AvatarGlyph`, `AnsiText`, `Backdrop`, `BackgroundTaskPanel`, `Badge`, `Banner`, `BarSeries`, `Button`, `ButtonGroup`, `Callout`, `Card`, `Chart`, `Checkbox`, `Chip`, `CitationList`, `ChoiceDialog`, `CodeBlock`, `CodeFrame`, `Collapsible`, `CommandPalette`, `Combobox`, `ConnectionManager`, `ContextMeter`, `Autocomplete`, `CompletionMenu`, `DataTable`, `DesignInspector`, `Description`, `DetailTable`, `Dialog`, `DiagnosticView`, `DiffView`, `Drawer`, `EmptyState`, `ErrorView`, `Field`, `Fieldset`, `FieldCaption`, `FileTree`, `FileMention`, `EntityMention`, `FileMention`, `Form`, `FormWizard`, `Gauge`, `Heading`, `HexViewer`, `Histogram`, `HighlightedText`, `HistoryPicker`, `HintBar`, `Icon`, `IconButton`, `Identity`, `ImageSurface`, `JumpOverlay`, `JumpMode`, `FocusLens`, `KeyboardHelp`, `Kbd`, `KeyValueList`, `Label`, `Link`, `List`, `LoadingView`, `LogPane`, `MarkdownView`, `Menu`, `MessageThread`, `MenuBar`, `MessageDialog`, `ModeRibbon`, `ModelSelector`, `Panel`, `Paragraph`, `PasswordInput`, `PasteChip`, `NumberInput`, `SearchInput`, `PathInput`, `TokenField`, `Select`, `MultiSelect`, `PermissionPrompt`, `ApprovalQueue`, `Picker`, `PlanReview`, `Popover`, `Progress`, `PromptComposer`, `PromptQueue`, `ProcessTable`, `QueryEditor`, `QuickOpen`, `QuestionFlow`, `RangeSlider`, `ResultGrid`, `ResizablePanelGroup`, `SchemaBrowser`, `SearchResults`, `MetricsDashboard`, `ScrollArea`, `Section`, `SegmentedControl`, `SegmentedMeter`, `Separator`, `SessionPicker`, `ShortcutHint`, `SlashCommandMenu`, `Slider`, `Skeleton`, `SourceCitation`, `Sparkline`, `SplitPane`, `Stepper`, `StatusBar`, `AgentStatusHeader`, `IntegrationStatus`, `SubagentCard`, `StreamingMarkdown`, `Surface`, `Table`, `Tabs`, `Tag`, `TaskRail`, `TerminalOutput`, `TerminalRunCard`, `Text`, `TextArea`, `TextInput`, `ThemePicker`, `ThinkingBlock`, `WorkingStateCard`, `Timeline`, `TraceWaterfall`, `DependencyGraph`, `Toast`, `Toggle`, `ToggleGroup`, `TokenStrip`, `Toolbar`, `TokenMeter`, `ToolCard`, `ToolCallCard`, `Transcript`, `Tree`, `Viewport`, and `VirtualGrid`.
