...
pub use app_shell::{
    ...
    app_shell_viewport, layout_app_shell,
};
pub use auth_entry::{
...
pub use file_manager::{
    FILE_MANAGER_BREADCRUMBS_HEIGHT, FILE_MANAGER_SEARCH_HEIGHT, FileClipboardMode,
    FileConflictResolution, FileManagerDensity, FileManagerDialog, FileManagerOutcome,
...
pub use observability_dashboard::{
    OBSERVABILITY_SEARCH_HEIGHT, ObservabilityDashboardOutcome, ObservabilityDashboardState,
...
pub use project_launcher::{
    PROJECT_LAUNCHER_SEARCH_HEIGHT, ProjectEntry, ProjectGroup, ProjectLauncherDensity,
...
pub use activity_shelf::{
    ...
    ActivityShelfState, ActivityStatusProjection, activities_to_notifications,
    activity_badge_label, activity_counts, activity_status_slot, activity_status_summary,
    activity_to_notification, example_activities, plan_activity_shelf,
    project_activities_for_status_bar, sort_activity_items,
};
pub use agent_status_header::bench as agent_status_header_bench;
pub use agent_status_header::{
    AGENT_STATUS_ACTION_CAP, AGENT_STATUS_HEADER_ID, AGENT_STATUS_NARROW_WIDTH,
    AgentConnectionStatus, AgentStatusAction, AgentStatusHeader, AgentStatusHeaderOutcome,
    AgentStatusHeaderState, AgentStatusPresentation, AgentStatusSnapshot, AgentWorkStatus,
    example_agent_status, example_agent_status_idle,
};
...
pub use background_task_panel::{
    BACKGROUND_TASK_DEFAULT_HISTORY, BACKGROUND_TASK_RAIL_WIDTH, BACKGROUND_TASKS_OVERLAY_ID,
...
pub use plan_review::{
    PLAN_REVIEW_BODY_WINDOW, PLAN_REVIEW_FULLSCREEN_OVERLAY_ID, PLAN_REVIEW_OVERLAY_ID, PlanAction,
    PlanAffectedFile, PlanAssumption, PlanComment, PlanCommentAnchor, PlanDocument, PlanFileChange,
    PlanReview, PlanReviewOutcome, PlanReviewPane, PlanReviewPhase, PlanReviewState, PlanRiskItem,
    PlanSection, PlanSourceRef, PlanTask, PlanTaskStatus, example_high_risk_plan,
    example_plan_document, remap_plan_comments,
};
...
pub use result_grid::{
    ...
    RESULT_TRUNC_MARK, ResultCell, ResultCellKind, ResultColumn, ResultColumnStats,
    ResultExportFormat, ResultGrid, ResultGridOutcome, ResultGridState, ResultQueryStatus,
    ResultRedaction, ResultRow, clamp_cell_display, export_result_window_tsv, format_result_cell,
...
pub use session_picker::{
    SESSION_PICKER_OVERLAY_ID, SESSION_PICKER_POPOVER_OVERLAY_ID,
    SESSION_PICKER_PROVIDER_SEARCH_MIN, SESSION_PICKER_WINDOW, SessionConfirmAction, SessionEntry,
    SessionLoadState, SessionLocation, SessionPicker, SessionPickerOutcome, SessionPickerPhase,
    SessionPickerPresentation, SessionPickerState, SessionStatus, example_sessions,
    filter_sessions,
};
...
pub use task_rail::{
    ActivityActionKind, ActivityDependency, ActivityModel, ActivityScope, TASK_RAIL_COMPACT_WIDTH,
    TASK_RAIL_DEP_CAP, TASK_RAIL_DRAWER_OVERLAY_ID, TASK_RAIL_DRAWER_WIDTH, TaskRail,
