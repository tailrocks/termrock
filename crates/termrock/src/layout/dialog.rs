...
//!
//! Modal dialogs follow the canonical vertical layout:
//!
//! ```text
//! ┌ Title ──────────────────────────────────────┐
...
impl DialogBodyScroll {
    ...
    /// [`Self::handle_key_for_axes`] for byte-oriented terminal adapters.
    /// dialog loop.
    ...
    /// Apply SGR wheel button bits to the shared dialog offsets. The
