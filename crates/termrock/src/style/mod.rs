...
pub use motion::{
    ...
    SCROLL_EASE_MAX, SCROLL_EASE_MIN, blend_toward, coalesce_cells, edge_fade, effective_alpha,
    fade_style, pulse_brightness, scroll_ease_duration, shimmer_at, shimmer_cells, smoothstep,
    wave_brightness,
};
use palette::{
