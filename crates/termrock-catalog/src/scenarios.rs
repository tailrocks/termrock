...
pub static ALL: &[Scenario] = &[
    ...
    cat("s_grid", PageId::GRID, 120, 40, &[]),
    cat("s_grid_80", PageId::GRID, 80, 24, &[]),
    cat("s_grid_failed", PageId::GRID, 120, 40, &[]),
    cat(
        "s_grid_pending",
        PageId::GRID,
        120,
        40,
        &[Step::Tab, Step::Enter, Step::Type("x"), Step::Enter],
    ),
    cat("s_grid_preview", PageId::GRID, 120, 40, &[Step::Char('p')]),
    cat(
        "s_pickers",
        PageId::PICKERS,
        120,
